	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login card -->
				<form class="login-form" method="POST" action="{{ route('countResult') }}">
					@csrf
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								<h1 class="mb-0 font-weight-black col">COUNTER</h1>
								<span class="d-block text-muted">Kwadran Lima Indonesia</span>
							</div>

							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="number" class="form-control" placeholder="Bilangan Ke 1" name="number[]" required>
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
								<input type="number" class="form-control" placeholder="Bilangan Ke 2" name="number[]" required>
								<div class="form-control-feedback">
									<i class="icon-list-numbered text-muted"></i>
								</div>
							</div>
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
								<input type="number" class="form-control" placeholder="Bilangan Ke 3" name="number[]" required>
								<div class="form-control-feedback">
									<i class="icon-list-numbered text-muted"></i>
								</div>
							</div>
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
								<input type="number" class="form-control" placeholder="Bilangan Ke 4" name="number[]" required>
								<div class="form-control-feedback">
									<i class="icon-list-numbered text-muted"></i>
								</div>
							</div>
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
								<input type="number" class="form-control" placeholder="Bilangan Ke 5" name="number[]" required>
								<div class="form-control-feedback">
									<i class="icon-list-numbered text-muted"></i>
								</div>
							</div>
